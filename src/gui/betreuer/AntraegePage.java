...
public class AntraegePage extends JPanel {
    ...
    private JComponent buildContent() {
        // Outer wrapper to match Student design
        ...
        JLabel h2 = new JLabel("Übersicht aller Anträge");
        ...
        // Main Message
        JLabel mainMessage = new JLabel("Keine Anträge erhalten");
        ...
        // Sub Message
        JLabel subMessage = new JLabel("<html><div style='text-align: center;'>Momentan liegen keine Anträge zur Bearbeitung vor.<br>Sobald Studierende ihre Bachelorarbeit anmelden, erscheinen die Anträge hier.</div></html>");
