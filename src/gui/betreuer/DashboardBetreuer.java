...
public class DashboardBetreuer extends JPanel {
   ...
   private JComponent buildScrollableContent() {
       ...
       content.setBorder(new EmptyBorder(48, 32, 64, 64)); // Gleiches Padding wie beim Studenten
       content.setLayout(new BoxLayout(content, BoxLayout.Y_AXIS));

       // Überschrift wie beim DashboardStudent - linksbündig
       JLabel h1 = new JLabel("Dashboard");
       h1.setFont(new Font("SansSerif", Font.BOLD, 22)); // Gleiche Schriftgröße 22 wie beim Studenten
       ...
       // Untertitel wie beim DashboardStudent - linksbündig
       ...
       cardsRow.setAlignmentX(Component.LEFT_ALIGNMENT); // Cards auch linksbündig
       ...
       // Benachrichtigungskarte linksbündig
       JPanel notificationsCard = (JPanel) makeNotificationsCard();
       notificationsCard.setAlignmentX(Component.LEFT_ALIGNMENT);
       content.add(notificationsCard);
   ...
   private JComponent makeNotificationsCard() {
       ...
       JLabel title = new JLabel("Letzte Benachrichtigungen");
       ...
       notificationsList.setBorder(new EmptyBorder(6, 18, 18, 18));
