...
public class ArbeitsstandBetreuer extends JPanel {
    ...
    public ArbeitsstandBetreuer(BetreuerFenster parent, String name, String email) {
        this.parent = parent;
    ...
    private JComponent buildContent() {
        ...
        JLabel h2 = new JLabel("Einblick in die Zwischenversionen Ihrer Studierenden");
        ...
        // Main Message
        JLabel mainMessage = new JLabel("Noch keine Uploads vorhanden");
        ...
        // Sub Message
        JLabel subMessage = new JLabel("<html><div style='text-align: center;'>Sobald Ihre Studierende Zwischenversionen hochladen,<br>erscheinen diese hier zur Begutachtung.</div></html>");
