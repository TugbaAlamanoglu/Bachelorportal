...
public class BachelorseminarPage extends JPanel {
    ...
    public BachelorseminarPage(StudiendekanFenster parent, String name, String email) {
        this.parent = parent;
    ...
    private JComponent buildContent() {
        ...
        JLabel h2 = new JLabel("Management des Bachelorseminars");
        ...
        // Calendar Icon (wie beim Studenten/Betreuer)
        ...
        // Main Message (wie beim Studenten/Betreuer)
        ...
        // Sub Message (wie beim Studenten/Betreuer)
