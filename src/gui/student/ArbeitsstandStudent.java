...
public class ArbeitsstandStudent extends JPanel {
    ...
    private JComponent buildLockedContent() {
        ...
        // Main Message
        JLabel mainMessage = new JLabel("Upload noch nicht verfügbar");
        ...
        // Sub Message
        JLabel subMessage = new JLabel("Diese Funktion ist erst nach der Anmeldung Ihrer Bachelorarbeit verfügbar.");
